...
<head>
  ...
  <!-- fullCalendar 2.2.5-->
  <link rel="stylesheet" href="{{ secure_asset('plugins/fullcalendar/fullcalendar.min.css') }}">
  <link rel="stylesheet" href="{{ secure_asset('plugins/fullcalendar/fullcalendar.print.css') }}" media="print">
  <!-- Theme style -->
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="{{ secure_asset('dist/img/user2-160x160.jpg') }}" class="user-image" alt="User Image">
              <span class="hidden-xs">Hadi Kusumanto</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
